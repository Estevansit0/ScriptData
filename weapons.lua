local ToolData = {
    ...
    ["PowerHuman"] = {
        Skills = {
            ["X"] = {Name = "Tempest Kick", ChargeTimeout = 3, ProcessDelay = 0.1, ReleaseDelay = 0, Delay = 11},
            ["C"] = {Name = "Power Impact", ChargeTimeout = 3, ProcessDelay = 0.3, ReleaseDelay = 0, Delay = 16},
    ...
    ["BlackLeg"] = {
        Skills = {
            ["X"] = {Name = "Breakdance", ChargeTimeout = 2, ProcessDelay = 0, ReleaseDelay = 0, Delay = 15},
            ["C"] = {Name = "Kick Barrage", ChargeTimeout = 3, ProcessDelay = 0, ReleaseDelay = 0, Delay = 20},
            ["Z"] = {Name = "Flying Kick", ChargeTimeout = 3, ProcessDelay = 0.9, ReleaseDelay = 0, Delay = 10},
        },
        M1s = {
            ["HitDelay"] = 0.6,
            ["Hitbox"] = Vector3.new(5, 5, 5),
    ...
    ["Combat"] = {
        Skills = {
            ["Z"] = {Name = "Ground Slam", ChargeTimeout = 3, ProcessDelay = 0.2, ReleaseDelay = 0.1, Delay = 7.5},
        },
        M1s = {
            ["HitDelay"] = 0.6,
            ["Hitbox"] = Vector3.new(5, 5, 5),
    ...
    ["Barrier"] = {
        Skills = {
            ["X"] = {Name = "Barrier Cubes", ChargeTimeout = 3, ProcessDelay = 0.2, ReleaseDelay = 0, Delay = 10.5},
            ["C"] = {Name = "Barrier Stairs", ChargeTimeout = 3, ProcessDelay = 0.1, ReleaseDelay = 0, Delay = 3},
            ["Z"] = {Name = "Barrier Crash", ChargeTimeout = 6, ProcessDelay = 0.2, ReleaseDelay = 0.1, Delay = 12},
        },
    },
    ["Bomb"] = {
        Skills = {
    ...
    ["Dough"] = {
        Skills = {
            ["X"] = {Name = "Burning Dough", ChargeTimeout = 3, ProcessDelay = 0.2, ReleaseDelay = 0.08, Delay = 12.75},
            ["C"] = {Name = "Dough Barrage", ChargeTimeout = 5, ProcessDelay = 0, ReleaseDelay = 0, Delay = 22.5},
            ["Z"] = {Name = "Dough Punch", ChargeTimeout = 3, ProcessDelay = 0.3, ReleaseDelay = 0, Delay = 9},
            ["E"] = {Name = "Roller Donut", ChargeTimeout = 20, ProcessDelay = 0.1, ReleaseDelay = 0, Delay = 7.5},
            ["V"] = {Name = "Buzzcut Dough", ChargeTimeout = 0, ProcessDelay = 4, ReleaseDelay = 0, Delay = 26.5},
        },
    },
    ["Flame"] = {
        Skills = {
            ["X"] = {Name = "Fire Pillar", ChargeTimeout = 3, ProcessDelay = 0.1, ReleaseDelay = 0.15, Delay = 15},
            ["C"] = {Name = "Fire Bullets", ChargeTimeout = 1.5, ProcessDelay = 0, ReleaseDelay = 0, Delay = 10.5},
            ["Z"] = {Name = "Fire Fist", ChargeTimeout = 3, ProcessDelay = 0.2, ReleaseDelay = 0, Delay = 7.5},
            ["E"] = {Name = "Fire Flight", ChargeTimeout = 20, ProcessDelay = 0, ReleaseDelay = 0, Delay = 7.5},
            ["V"] = {Name = "Flame Emperor", ChargeTimeout = 3, ProcessDelay = 0.3, ReleaseDelay = 0.15, Delay = 27},
        },
    },
    ["Ice"] = {
        Skills = {
            ["V"] = {Name = "Ice Age", ChargeTimeout = 3, ProcessDelay = 0.4, ReleaseDelay = 0.1, Delay = 26},
            ["X"] = {Name = "Ice Stomp", ChargeTimeout = 3, ProcessDelay = 0.3, ReleaseDelay = 0.1, Delay = 14},
            ["C"] = {Name = "Icicle Rain", ChargeTimeout = 3, ProcessDelay = 0.2, ReleaseDelay = 0.1, Delay = 15},
    ...
    ["Light"] = {
        Skills = {
            ...
            ["C"] = {Name = "Starlight", ChargeTimeout = 3, ProcessDelay = 0.2, ReleaseDelay = 0, Delay = 13.5},
    ...
    ["Magma"] = {
        Skills = {
            ["V"] = {Name = "Magma Shower", ChargeTimeout = 4, ProcessDelay = 0, ReleaseDelay = 0, Delay = 24},
            ["X"] = {Name = "Magma Eruption", ChargeTimeout = 3, ProcessDelay = 0.1, ReleaseDelay = 0.1, Delay = 10.5},
            ["C"] = {Name = "Hell Bound", ChargeTimeout = 3, ProcessDelay = 0.3, ReleaseDelay = 0, Delay = 13.5},
            ["Z"] = {Name = "Magma Fist", ChargeTimeout = 3, ProcessDelay = 0.2, ReleaseDelay = 0.2, Delay = 7.5},
        },
    },
    ["Paw"] = {
        Skills = {
            ["X"] = {Name = "Paw Barrage", ChargeTimeout = 1.25, ProcessDelay = 0, ReleaseDelay = 0, Delay = 10},
            ["C"] = {Name = "Paw Nuke", ChargeTimeout = 3, ProcessDelay = 0.3, ReleaseDelay = 0, Delay = 16},
            ["Z"] = {Name = "Paw Shot", ChargeTimeout = 3, ProcessDelay = 0.2, ReleaseDelay = 0, Delay = 5},
        },
    },
    ["Quake"] = {
        Skills = {
            ["V"] = {Name = "Sea Quake", ChargeTimeout = 3, ProcessDelay = 1, ReleaseDelay = 0.2, Delay = 31.5},
            ["X"] = {Name = "Quake Stomp", ChargeTimeout = 3, ProcessDelay = 1, ReleaseDelay = 0.1, Delay = 13.5},
            ["C"] = {Name = "Air Crusher", ChargeTimeout = 3, ProcessDelay = 1, ReleaseDelay = 0.35, Delay = 18},
            ["Z"] = {Name = "Tremor Crush", ChargeTimeout = 3, ProcessDelay = 1, ReleaseDelay = 0, Delay = 10.5},
        },
    },
    ["Rumble"] = {
        Skills = {
            ["V"] = {Name = "Thunder Spirit", ChargeTimeout = 5, ProcessDelay = 0.3, ReleaseDelay = 0.15, Delay = 30},
            ["X"] = {Name = "Sky Judgement", ChargeTimeout = 4, ProcessDelay = 0.6, ReleaseDelay = 0, Delay = 19},
            ["C"] = {Name = "Godspeed", ChargeTimeout = 2, ProcessDelay = 1, ReleaseDelay = 0, Delay = 13},
    ...
    ["Sand"] = {
        Skills = {
            ...
            ["C"] = {Name = "Quicksand", ChargeTimeout = 3, ProcessDelay = 0, ReleaseDelay = 0, Delay = 15},
            ...
            ["V"] = {Name = "Sand Tornado", ChargeTimeout = 3, ProcessDelay = 0.2, ReleaseDelay = 0.1, Delay = 21},
        },
    },
    ["Smoke"] = {
        Skills = {
            ["E"] = {Name = "Smoke Flight", ChargeTimeout = 15, ProcessDelay = 0, ReleaseDelay = 0, Delay = 7.5},
            ["X"] = {Name = "Smoke Prison", ChargeTimeout = 0, ProcessDelay = 0.2, ReleaseDelay = 0.1, Delay = 15},
            ["Z"] = {Name = "White Snake", ChargeTimeout = 3, ProcessDelay = 0.2, ReleaseDelay = 0, Delay = 5},
        },
    },
    ["Spike"] = {
        Skills = {
